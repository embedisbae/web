...
<div class="bg-light pt-5 pb-3">
  <div class="container text-justify mb-4">
    <h2 class="font-weight-bold">We have some partners!</h2>
    <p>Be sure to check out some of our cool partners over here.</p>
    <div class="card border-0 shadow-lg mb-3">
      <div class="card-body">
        <div class="media">
          <a href="https://file.coffee"><img alt="file.coffee Logo" src="https://file.coffee/QGUrNODuz.png" class="mr-3 w-10 rounded img-p" draggable="false"></a>
    ...
    <div class="card border-0 shadow-lg mb-3">
      <div class="card-body">
        <div class="media">
          <a href="https://points.city"><img alt="Points Logo" src="https://points.city/images/logo/Discord.png" class="mr-3 w-10 rounded img-p" draggable="false"></a>
          <div class="media-body">
    ...
    <div class="card border-0 shadow-lg">
      <div class="card-body">
        <div class="media">
          <a href="https://crystalbotlist.uk"><img alt="CrystalBotList Logo" src="https://file.coffee/OZ5vZd6xF.png" class="mr-3 w-10 rounded img-p" draggable="false"></a>
          <div class="media-body">
